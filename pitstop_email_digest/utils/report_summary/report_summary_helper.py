...
from automotive.automotive.report.workshop_productivity.workshop_productivity import execute as WorkshopProductivityReportExecute
from automotive.automotive.report.workshop_turnover.workshop_turnover import execute as WorkshopTurnoverReportExecute
