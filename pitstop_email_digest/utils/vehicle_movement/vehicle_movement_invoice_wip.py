...
def fetch_revenue_others_group_based_on_ro_wip(
    from_date,
    to_date,
    cost_center,
    customer_group_list,
...
def fetch_revenue_vehicle_group_based_on_ro_wip(
    from_date,
    to_date,
    cost_center,
    vehicle_variant,
...
def fetch_revenue_customer_group_based_on_ro_wip(
    from_date,
    to_date,
    cost_center,
    customer_group,
...
def fetch_revenue_branchwise_based_on_costcenter(from_date, to_date, wip_timespan):
    autoworks_customer_group_list = fetch_field_group_list_data(
        "autoworks_customer_group_list_invoice_wip_map",
        "customer_group",
        "Customer Group Details",
    )
    autocare_customer_group_list = fetch_field_group_list_data(
        "autocare_customer_group_list_invoice_wip_map",
        "customer_group",
        "Customer Group Details",
    )
    ...
    for each_cost_center in cost_center_list:
        ...
        if each_cost_center == "AutoWorks - PASLLC":
            for each_customer_group in autoworks_customer_group_list:
                customer_group_details = fetch_revenue_customer_group_based_on_ro_wip(
                    fiscal_start,
                    fiscal_end,
                    each_cost_center,
                    each_customer_group,
