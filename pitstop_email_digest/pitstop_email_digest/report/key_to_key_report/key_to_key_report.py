...
class VehicleKeyToKeyReport(object):
	...
	def get_columns(self):
		columns = [
			{"label": _("Vehicle"), "fieldname": "applies_to_vehicle", "fieldtype": "Data", "width": 120},
			{"label": _("Customer"), "fieldname": "customer", "fieldtype": "Link", "options": "Customer", "width": 80},
			{"label": _("Customer Name"), "fieldname": "customer_name", "fieldtype": "Data", "width": 150},
			{"label": _("Customer Group"), "fieldname": "customer_group", "fieldtype": "Data", "width": 150},
			{"label": _("Vehicle Received Date/Time"), "fieldname": "vehicle_received_dt_fmt", "fieldtype": "Data", "width": 160},
			{"label": _("Delivered Date/Time"), "fieldname": "vehicle_delivered_dt_fmt", "fieldtype": "Data", "width": 140},
			{"label": _("Duration/ Key to Key (Days)"), "fieldname": "age", "fieldtype": "Int", "width": 150},
			{"label": _("Vehicle Ready for collection Date/Time"), "fieldname": "ready_to_close_dt_fmt", "fieldtype": "Data", "width": 160},
			{"label": _("Promised Date/Time"), "fieldname": "expected_delivery_dt_fmt", "fieldtype": "Data", "width": 140},
			...
			{'label': _("Job Date"), 'fieldname': 'project_date', 'fieldtype': 'Date', 'width': 80},
			{"label": _("Ready"), "fieldname": "ready_to_close", "fieldtype": "Check", "width": 50},
			{"label": _("Billed"), "fieldname": "billed", "fieldtype": "Check", "width": 50},
			{"label": _("Delivered"), "fieldname": "delivered", "fieldtype": "Check", "width": 55},
			{"label": _("Workshop"), "fieldname": "vehicle_workshop", "fieldtype": "Link", "options": "Vehicle Workshop", "width": 120},
			{"label": _("Workshop Division"), "fieldname": "vehicle_workshop_division", "fieldtype": "Data", "width": 100},
			...
			{"label": _("Reg No"), "fieldname": "vehicle_license_plate", "fieldtype": "Data", "width": 100},
			...
			{"label": _("Bill To"), "fieldname": "bill_to", "fieldtype": "Link", "options": "Customer", "width": 80},
			{"label": _("Bill To Name"), "fieldname": "bill_to_name", "fieldtype": "Data", "width": 150},
			{"label": _("Contact #"), "fieldname": "contact_no", "fieldtype": "Data", "width": 100},
			{'label': _("Job Status"), 'fieldname': 'project_status', 'fieldtype': 'Data', 'width': 110},
			{'label': _("Material Status"), 'fieldname': 'delivery_status', 'fieldtype': 'Data', 'width': 110},
			{'label': _("Procurement Status"), 'fieldname': 'procurement_status', 'fieldtype': 'Data', 'width': 100},
			{"label": _("Billable Amount"), "fieldname": "total_billable_amount", "fieldtype": "Currency",
				"options": "Company:company:default_currency", "width": 100},
			{"label": _("Pending Quotation Amount"), "fieldname": "pending_quotation_amount", "fieldtype": "Currency",
				"options": "Company:company:default_currency", "width": 100},
			{"label": _("Ready Date/Time"), "fieldname": "ready_to_close_dt_fmt", "fieldtype": "Data", "width": 140},
			{"label": _("Ready in Days"), "fieldname": "ready_days", "fieldtype": "int", "width": 75},
			{"label": _("Final Invoice Date"), "fieldname": "final_invoice_date_fmt", "fieldtype": "Data", "width": 90},
			{"label": _("Invoiced in Days"), "fieldname": "invoiced_days", "fieldtype": "int", "width": 75},
			{"label": _("Last MR Date"), "fieldname": "last_material_request_date", "fieldtype": "Date", "width": 90},
			{"label": _("Last PO Date"), "fieldname": "last_purchase_order_date", "fieldtype": "Date", "width": 90},
			{"label": _("Last PR Date"), "fieldname": "last_purchase_receipt_date", "fieldtype": "Date", "width": 90},
			{"label": _("Created On"), "fieldname": "creation_dt_fmt", "fieldtype": "Data", "width": 90},
			{"label": _("RO to Invoice Days"), "fieldname": "ro_to_invoice", "fieldtype": "Data", "width": 90},
		]

		if self.filters.get("workshop_division") == "Bodyshop":
			columns.extend(
				[
					{"label": _("Insurance Claim #"), "fieldname": "insurance_loss_no", "fieldtype": "Data", "width": 130},
				]
			)
