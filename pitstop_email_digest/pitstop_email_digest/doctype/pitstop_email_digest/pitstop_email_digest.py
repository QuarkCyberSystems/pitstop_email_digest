...
from pitstop_email_digest.utils.report_summary.report_summary_helper import (
...
class PitstopEmailDigest(CoreDigest):
        ...
        if not custom_method:
            ...
            try:
                ...
                frappe.log_error(
                    ...
                    _("Error in custom method HTML for Pitstop Email Digest"),
                )
    ...
    def _build_kpi(self, start_date, end_date):
        ...
        for r in rows:
            ...
            # ---------------- Parts bucket ---------------------------
                ...
                # r.is_stock_item
                r.item_group in mats or r.item_group in paints
                # or r.item_group in subs
            ):
                parts_amt += r.net_amount

            # ---------------- Consumables & Others -------------------
            elif r.item_group in cons or r.item_group in lubes or r.item_group in subs:
    ...
    def _expanded_kpi_table(self):
        ...
        return [
            [
                "Details",
                "Daily<br/>(" + str(format_date(today, "dd-mm-yyyy") + ")"),
            ...
            [
                ...
                round_dirham(
                    self.get_back_date_data(
                        ...
                        ["01", current_month_number],
                    )
                ),
            ],
            [
                "Labour Hours",
                round_dirham(daily.labour_hours),
            ...
            [
                "Labour Amount",
                round_dirham(daily.labour_amount),
            ...
            [
                "Parts Amount",
                round_dirham(daily.parts_amount),
            ...
            [
                "Consumables & Others",
                round_dirham(daily.cons_amount),
            ...
            [
                ...
                round_dirham(daily.labour_rate),
            ...
            [
                "Hours per RO",
                round_dirham(daily.hours_per_ro),
